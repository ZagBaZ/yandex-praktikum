...
class StaticURLTests(TestCase):
    ...
    def test_pages_uses_correct_template(self):
        templates_pages_names = {
            ...
            'posts/update_post.html': reverse('posts:post_edit', kwargs={'post_id': '1'}),
        }
    ...
    def test_post_detail_page_show_correct_contex(self):
        response = self.authorized_client.get(reverse('posts:post_detail', kwargs={'post_id': '1'})).context['post']
